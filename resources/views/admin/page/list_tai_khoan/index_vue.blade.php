                                ...
                                <tbody>
                                    <tr>
                                        <div class="input-group mb-3">
                                            <input v-model="search.tt" v-on:keyup.enter="timKiem()" type="text" class="form-control" placeholder="Nhập thông tin cần tìm"> <span class="input-group-text" >
                                                <button v-on:click="timKiem()" class="btn "><i class="fa-solid fa-magnifying-glass fa-beat" style="color: #0ebee1;"></i></button>
                                            </span>
                                        </div>
                                    </tr>
